  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        lot: {
          available: "hsl(var(--lot-available))",
          reserved: "hsl(var(--lot-reserved))",
          sold: "hsl(var(--lot-sold))",
          selected: "hsl(var(--lot-selected))",
        },
        header: {
      ...
      keyframes: {
        ...
        "urgent-pulse": {
          ...
          "50%": { transform: "scale(1.01)", filter: "drop-shadow(0 0 10px rgba(255, 0, 0, 0.55))" },
        },
        shine: {
